      ...
      <motion.div style={{ y: parallaxY, opacity }} className="relative z-10 text-center max-w-5xl mx-auto px-6">
        ...
        >
          ...
          <div className="overflow-hidden mb-4">
            <motion.h1 custom={1} variants={textReveal} className="font-display font-900 text-5xl md:text-7xl lg:text-8xl leading-[0.95] tracking-tight">
              <span className="text-gradient">Creative Media</span>
            </motion.h1>
          </div>
          <div className="overflow-hidden mb-4">
            <motion.h1 custom={2} variants={textReveal} className="font-display font-900 text-5xl md:text-7xl lg:text-8xl leading-[0.95] tracking-tight text-foreground">
              & Digital Marketing
            </motion.h1>
          </div>
          <div className="overflow-hidden mb-8">
            <motion.h1 custom={3} variants={textReveal} className="font-display font-900 text-5xl md:text-7xl lg:text-8xl leading-[0.95] tracking-tight">
        ...
        >
          ...
          <a
            href="#contact"
            className="px-8 py-3 font-display font-semibold text-sm tracking-wider uppercase bg-foreground text-background rounded-full hover:bg-primary hover:text-primary-foreground transition-all duration-500"
          >
            Book Now
          </a>
        </motion.div>
