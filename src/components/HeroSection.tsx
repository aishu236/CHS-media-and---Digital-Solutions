    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto px-6">
        ...
        >
          ...
          content direction, and digital strategy.
        </motion.p>
        ...
        >
          <a
            href="#works"
            className="glass-card px-8 py-3 font-display font-semibold text-sm tracking-wider uppercase text-primary border border-primary/30 hover:border-primary/60 hover:shadow-[0_0_30px_hsl(var(--primary)/0.2)] transition-all duration-500"
          >
            View Works
          </a>
          <a
